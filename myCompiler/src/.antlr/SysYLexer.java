...
public class SysYLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"IDENTIFIER_DIGIT", "IDENTIFIER", "NONZERO_DIGIT", "DECIMAL_CONST", "OCTAL_CONST", 
			"HEXADECIMAL_CONST", "OCTAL_DIGIT", "HEXADECIMAL_DIGIT", "FLOAT_PART_A", 
			"FLOAT_PART_B", "EXPONENT_PART", "FLOAT_CONST", "COMMENT", "WS"
		};
	}
