...
private:
    ...
    shared_ptr<RISCVRegister> getOrCreateVectorReg(Value *value, bool isPhysical = false);
    shared_ptr<RISCVRegister> LiInt(int intValue, bool isPhysical = false, bool copyInit = false);
    shared_ptr<RISCVRegister> LiFloat(float floatValue, bool isPhysical = false, bool copyInit = false);
    shared_ptr<RISCVRegister> LiLong(long longValue, bool isPhysical = false, bool copyInit = false);
    ...
    unordered_map<string, shared_ptr<RISCVRegister>> moveCallerArgsTwoPhase(const string &calleeName);
