...
当前稳定基线：`664fedd`（`InvariantDivisorNestVersion`），线上约 **94.47s AC**。  
上一基线：`abe591d`（`LoopAPModSumFold`，103.37s）。  
...
|------|-----|------|---------|---------|
| 01_mm2/3/1 | 4.68 / 2.93 / 1.33 | 0.04 / 0.03 / 0.02 | 117 / 98 / 66 | ≈0.01 |
| many_mat* | ≈11 | ≈1.1–1.3 | ≈9–10 | ≈0.1 |
| sl2/1/3 | 7.22 / 3.71 / 0.45 | 0.94 / 0.48 / 0.06 | ≈7.7 | ≈0.13 |
