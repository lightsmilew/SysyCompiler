...
2.函数栈帧疑似有问题，出现在循环中连续赋值的时候，比如 a=d,b=a,c=b,d=a，问题具体出现在样例2025-EQV-46.sy的135行到139行位置  
3.中端新增mulhd指令，效果为64位乘法取高64位-->已处理4.有条件跳转和比较指令的指令选择需要优化，目前是先比较再跳转，应该可以合并成一条指令-->已处理5.寄存器分配的溢出代价计算需要更加精细  
6.指令融合还没查看use-def链，可能存在问题
